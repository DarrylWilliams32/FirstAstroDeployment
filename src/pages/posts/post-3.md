...
It wasn't always smooth sailing, but I'm enjoying building with Astro. I've been following along with the tutorial on Astro's [Website](https://docs.astro.build/en/tutorial/3-components/) and their [Discord community](https://astro.build/chat)! I've learned a lot by using both. 